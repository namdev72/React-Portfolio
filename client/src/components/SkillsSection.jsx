...
const skills = [
  ...
  { name: "Python", level: 85, category: "languages", icon: "python" },
  { name: "Java", level: 80, category: "languages", icon: "java" },
  { name: "C++", level: 85, category: "languages", icon: "typescript" },
  { name: "C", level: 75, category: "languages", icon: "vscode" },
  ...
  { name: "SCSS", level: 85, category: "frontend", icon: "sass" },
  { name: "Tailwind CSS", level: 90, category: "frontend", icon: "css" },
  { name: "Responsive Design", level: 95, category: "frontend", icon: "html" },

  // Backend & DB
  { name: "Node.js", level: 85, category: "backend", icon: "nodejs" },
  { name: "Express.js", level: 85, category: "backend", icon: "express" },
  { name: "REST APIs", level: 90, category: "backend", icon: "graphql" },
  { name: "MongoDB", level: 90, category: "backend", icon: "mongodb" },
  { name: "MySQL", level: 85, category: "backend", icon: "mysql" },
  { name: "SQL", level: 85, category: "backend", icon: "sql" },

  // AI & GenAI
  { name: "Google Gemini API", level: 90, category: "ai", icon: "python" },
  { name: "LangChain", level: 85, category: "ai", icon: "python" },
  { name: "OpenAI API", level: 85, category: "ai", icon: "python" },
  { name: "Hugging Face", level: 75, category: "ai", icon: "python" },
  { name: "Prompt Engineering", level: 95, category: "ai", icon: "vscode" },
  ...
  { name: "AWS", level: 70, category: "tools", icon: "docker" },
];

const categories = [
  { id: "all", label: "All Skills", color: "bg-gradient-to-r from-purple-500 to-pink-500" },
  { id: "languages", label: "Languages", color: "bg-gradient-to-r from-teal-500 to-emerald-500" },
  ...
  { id: "ai", label: "AI & GenAI", color: "bg-gradient-to-r from-indigo-500 to-purple-500" },
