...
const projects = [
  {
    ...
    demoUrl: "#",
    githubUrl: "https://github.com/namdev72",
    featured: true,
    accentColor: "from-emerald-500 to-teal-600",
    status: "Live",
    highlights: ["Resume Parsing & Gemini AI Analysis", "Personalized AI Interview Plans", "Interactive Match & Roadmaps", "JWT Authentication & History Reports"]
  },
  {
    id: 2,
    ...
    status: "Live",
    highlights: ["Playwright Browser Interaction", "LangChain Reasoning Agent", "Dynamic DOM Parsing", "Autonomous Page Planning"]
  },
  {
    id: 3,
    title: "StarVideo",
    ...
    status: "Live",
    highlights: ["JWT Auth & Secured Middlewares", "Video uploads and streaming", "Likes & Subscriptions System", "Cloudinary Integration"]
  },
  {
    id: 4,
    title: "BookLoop",
...
const categoryColors = {
  ...
  "AI Automation": "from-blue-500/20 to-cyan-600/20 text-blue-600 border-blue-500/30",
  "Backend Engineering": "from-purple-500/20 to-indigo-600/20 text-purple-600 border-purple-500/30",
  "Web App": "from-rose-500/20 to-pink-600/20 text-rose-600 border-rose-500/30"
};
