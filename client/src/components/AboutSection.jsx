...
export const AboutSection = () => {
  ...
  const techStack = [
    { category: "Frontend", items: ["React.js", "HTML5/CSS3", "Tailwind CSS", "JavaScript (ES6+)"] },
    { category: "Backend & DB", items: ["Node.js", "Express.js", "REST APIs", "MongoDB", "MySQL/SQL"] },
  ...
  const socialLinks = [
    ...
    { icon: <Linkedin className="h-5 w-5" />, href: "https://www.linkedin.com/in/kartik-namdev/" },
    { icon: <Mail className="h-5 w-5" />, href: "mailto:namdevkartik72@gmail.com" }
  ];
              ...
              <div className="relative">
                <div className="flex flex-col md:flex-row items-center gap-6 md:gap-8">
                  ...
                  <div className="flex-1 text-center md:text-left">
                    <h2 className="text-2xl sm:text-3xl font-bold mb-1 sm:mb-2">Kartik Namdev</h2>
                    <p className="text-primary text-base sm:text-lg font-semibold mb-3 sm:mb-4">Full Stack MERN & Generative AI Developer</p>
