  ...
  const testimonials = [
    {
      ...
      content: `Working with Kartik was seamless from day one. Not only did they deliver a full-stack solution ahead of schedule, but they also communicated clearly throughout the project. It's rare to find a developer who understands both the tech and the business side so well`,
      rating: 5,
    ...
    },
    {
      ...
      content: `I've reviewed hundreds of portfolios, and his work is truly exceptional. The way the animations guide attention while maintaining performance is masterful. The gradient elements add depth without overwhelming.`,
      rating: 5,
    ...
    },
    {
      ...
      content: `From wireframes to deployment, Kartik owned the entire stack with confidence and creativity. The final product is fast, reliable, and looks incredible. I wouldn't hesitate to work with them again.`,
      rating: 5,
