...
export const Footer = () => {
  ...
  const socialLinks = [
    { icon: <Linkedin size={18} />, href: "https://www.linkedin.com/in/kartik-namdev/", label: "LinkedIn" },
    { icon: <Github size={18} />, href: "https://github.com/namdev72", label: "GitHub" },
  ];
  ...
  const contactInfo = [
    { icon: <Mail size={16} />, text: "namdevkartik72@gmail.com", href: "mailto:namdevkartik72@gmail.com" },
    { icon: <Phone size={16} />, text: "+91 9589179447", href: "tel:+919589179447" },
  ];
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <motion.div variants={itemVariants} className="space-y-4">
              <h3 className="text-xl font-bold text-gray-900 dark:text-white">KARTIK</h3>
              <p className="text-gray-600 dark:text-gray-300 text-sm">
                Final Year CSE Student & Full Stack MERN / GenAI Developer.
              </p>
          ...
          >
            <div>
              <p>© {currentYear} Kartik Namdev. All rights reserved.</p>
            </div>
